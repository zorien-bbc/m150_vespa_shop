...
INSERT INTO `Bestellung` VALUES (11,1,NULL,'Bestellt'),(12,1,NULL,'Bestellt'),(13,1,NULL,'Bestellt'),(14,1,NULL,'Bestellt'),(15,1,NULL,'Bestellt'),(16,1,NULL,'Bestellt'),(17,1,NULL,'Bestellt'),(18,1,'Sun Jan 14 19:11:09 CET 2018','Bestellt'),(19,1,NULL,'Offen');
...
INSERT INTO `Kategorie` VALUES (1,'Elektronik'),(2,'Getriebe'),(3,'Bremsen'),(4,'Kupplungen'),(5,'Rahmen'),(6,'Scheinwerfer'),(7,'Seilzüge'),(8,'Stossdämpfer'),(9,'Vergaser'),(10,'Zündungen'),(11,'Zylinder');
...
INSERT INTO `Kunde` VALUES (1,'test','test','test','test','test','test','test','test',NULL),(2,'admin','admin','admin','admin','admin','admin','admin','admin',1);
...
INSERT INTO `Produkt` VALUES (1,'Gas','Gas',150,'21',13,9),(2,'Elektronik','Jflkdsjf',193.33,'3893',348,1),(3,'weisauned','jfdskl',381,'fjdaf',9993,1),(4,'Geil','Geil',31.3,'31843',13382,6),(5,'fda','fdsakfjfdflkdajsjfdsklöf fdjfadslkfjdaslkfjsdaf fdasjlfjdsaölfkj dsfjkdslfajölfj',9.4,'131800318',31813,1),(6,'bitte','fdsafadsf fasdf  fasd  f f fd dsa f s fa dsf fdsafadsf fasdf  fasd  f f fd dsa f s fa dsf ',89.3,'1371-318',130880,2),(7,'gogo','fasdff fadsfjadsf lökdsfjkldsöjfa',83.2,'831-2381',833838,4);
...
INSERT INTO `Warenkorb` VALUES (19,1),(11,2),(13,2),(11,3),(18,3),(15,4),(17,5),(18,5),(11,6),(16,6),(18,6),(12,7),(14,7);
...
-- Dump completed on 2018-01-14 20:07:31
